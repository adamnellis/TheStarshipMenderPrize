...
export default class EnemyMoveFunction extends Enemy {
	 ...
	 */
	constructor(scene, player, bullets, collectibles, image_name, rotation_angle, shoot_speed, health) {
		super(scene, player, bullets, collectibles, -10, -10, image_name, 0, 0, rotation_angle, shoot_speed, health);
		this.time = 0;
	}
