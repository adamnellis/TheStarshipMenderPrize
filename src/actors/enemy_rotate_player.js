...
export default class EnemyRotatePlayer extends Enemy {
	 ...
	 */
	constructor(scene, player, bullets, collectibles, x, y, image_name, rotation_angle = Math.PI / 2, shoot_speed = 2) {

		// rotation, assuming 0 is up the y axis (because that's how the image is on the sprite sheet)
		super(scene, player, bullets, collectibles, x, y, image_name, rotation_angle, ROTATION_RATE, ROTATION_DAMPING, shoot_speed);
	}
